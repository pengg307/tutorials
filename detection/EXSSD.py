...
WEIGHTS_URL = '~/pengg307/weights_EXSSD.hdf5'

voc_classes = ['Bicycle', 'Bus', 'Car', 'Cat', 'Dog', 'Horse', 'Motorbike', 'Person']
...
def EXSSD300(input_shape, num_classes=21, pretrained=True):
    """EXSSD300 architecture.
    ...
    if pretrained:
        model.load_weights(WEIGHTS_URL, by_name=True)
...
def get_SSD_model():
    ...
    model_ssd = EXSSD300(input_shape=(300, 300, 3), num_classes=NUM_CLASSES, pretrained=True)
